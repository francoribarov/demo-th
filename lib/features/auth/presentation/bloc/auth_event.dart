...
abstract class AuthEvent with _$AuthEvent {
  ...
  const factory AuthEvent.registerEmailChanged(String email) = _RegisterEmailChanged;

  /// Updates the register password input.
  const factory AuthEvent.registerPasswordChanged(String password) = _RegisterPasswordChanged;

  /// Updates the repeated register password input.
  const factory AuthEvent.registerPasswordConfirmChanged(String confirmPassword) = _RegisterPasswordConfirmChanged;

  /// Toggles password visibility for register form inputs.
  const factory AuthEvent.registerPasswordVisibilityToggled() = _RegisterPasswordVisibilityToggled;

  /// Updates the register username input.
  const factory AuthEvent.registerUsernameChanged(String username) = _RegisterUsernameChanged;

  /// Updates the register location input.
  const factory AuthEvent.registerLocationChanged(String location) = _RegisterLocationChanged;
