...
abstract class $AuthSessionCopyWith<$Res> {
  factory $AuthSessionCopyWith(AuthSession value, $Res Function(AuthSession) then) =
...
class _$AuthSessionCopyWithImpl<$Res, $Val extends AuthSession> implements $AuthSessionCopyWith<$Res> {
  ...
  @override
  $Res call({Object? user = freezed, Object? tokens = null}) {
    return _then(
      _value.copyWith(
            user: freezed == user
                ? _value.user
...
abstract class _$$AuthSessionImplCopyWith<$Res> implements $AuthSessionCopyWith<$Res> {
  factory _$$AuthSessionImplCopyWith(_$AuthSessionImpl value, $Res Function(_$AuthSessionImpl) then) =
...
/// @nodoc
class __$$AuthSessionImplCopyWithImpl<$Res> extends _$AuthSessionCopyWithImpl<$Res, _$AuthSessionImpl>
...
class _$AuthSessionImpl implements _AuthSession {
  const _$AuthSessionImpl({this.user, required this.tokens});
...
abstract class _AuthSession implements AuthSession {
  const factory _AuthSession({final User? user, required final AuthTokens tokens}) = _$AuthSessionImpl;
